...
| [`plans/refactor.md`](plans/refactor.md) | implementation source of truth for the 0.1.0 refactor |

Installation and operations live in the root [README](../README.md) and
[runbook](../RUNBOOK.md). Static host assets live under `plugins/`; their host
